...
const { createSubscription, getSubscriptionByPatient, getSubscribedClinicians, checkActiveSubscription } = require('../controllers/subscriptionController');
...
router.route('/update-patient-by-admin/:id').put(updatePatientByAdmin);
router.route('/delete-patient-by-admin/:id').delete(deletePatientByAdmin);
